...
const PipelineSimulator = ({ lang }) => {
  ...
  const logDatabase = {
    ...
    stage4: [
      ...
      "kubectl set image deployment/portfolio-app portfolio-container=harbor.local/renaldy/portfolio:v1.0.0 --record",
      ...
      "GET https://portfolio.staging.renaldy.dev/health-check => 200 OK (latency: 42ms)",
      "GET https://portfolio.staging.renaldy.dev/api/status => 200 OK (latency: 18ms)",

  ...
  const chatbotData = {
    id: {
      ...
      responses: {
        ...
        cv: "Tentu! Anda bisa mengakses dan mencetak CV Bahasa Indonesia melalui CV Builder kami di link berikut: <a href='/?mode=cv-builder' class='project-link' style='color: var(--accent); font-weight:700;'>[Buka CV Builder]</a> atau unduh CV default versi Inggris di sini: <a href='/cv-renaldy.pdf' download class='project-link' style='color: var(--accent); font-weight:700;'>[Unduh CV Default (Inggris).pdf]</a>",

document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    id: {
      ...
      "hero-title": "Membangun <span class='gradient-text'>Infrastruktur Cloud</span> yang Tangguh.",
      "hero-desc": "Lulusan Sarjana Teknik Informatika dengan keahlian di bidang IT Network Operation Center dan Cloud Computing. Berpengalaman mengelola AWS, GCP, dan Docker untuk efisiensi sistem.",
    ...
    en: {
      ...
      "nav-contact": "Contact",
      "hero-eyebrow": "Cloud Engineer & IT Specialist",
      "hero-title": "Building Resilient <span class='gradient-text'>Cloud Infrastructure</span>.",
      "hero-desc": "Computer Science graduate specializing in IT Network Operation Center and Cloud Computing. Experienced in managing AWS, GCP, and Docker for system efficiency.",
